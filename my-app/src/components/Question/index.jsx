      ...
      <div className="hidden md:flex md:w-1/3 bg-gradient-to-b from-gray-900 to-gray-950 flex-col items-center justify-center p-8 relative border-r border-gray-800">
        <div className="relative w-64 h-64 bg-gray-800/50 rounded-full flex items-center justify-center mb-12 overflow-hidden">
          ...
          <div className="absolute w-56 h-56 bg-gray-900 rounded-full flex items-center justify-center z-10">
            <code className="text-cyan-400 text-4xl font-mono">{`{ }`}</code>
          </div>
          ...
          <div className="absolute -left-8 bottom-12 z-20">
            <code className="text-cyan-400 text-xl font-mono">[]</code>
          </div>
        </div>
      ...
      <div className="w-full md:w-2/3 bg-gray-950 flex flex-col p-6">
        <div className="w-full max-w-4xl mx-auto flex-1 flex flex-col">
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="bg-cyan-950/50 text-cyan-400 text-sm font-medium py-2 px-4 rounded-md inline-block border border-cyan-900/50">
              Algorithm Challenge
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
              <p className="text-gray-300 mb-4">
                ...
                <code className="bg-gray-800 px-1 rounded text-cyan-400">
                  nums
                </code>{" "}
                and an integer{" "}
                <code className="bg-gray-800 px-1 rounded text-cyan-400">
              ...
              <div className="mt-6">
                ...
                <div className="bg-gray-800 p-4 rounded-md font-mono text-sm">
                  <p className="text-gray-300">
                    <span className="text-cyan-400">Input:</span> nums =
                    [2,7,11,15], target = 9
                  </p>
                  <p className="text-gray-300">
                    <span className="text-cyan-400">Output:</span> [0,1]
                  </p>
                  <p className="text-gray-300">
                    <span className="text-cyan-400">Explanation:</span> Because
          ...
          {/* IDE Section - Placeholder for third-party integration */}
          <div className="flex-1 bg-gray-900 rounded-lg border border-gray-800 mb-6 min-h-[300px] flex items-center justify-center">
            <div className="text-center p-6">
              <p className="text-gray-400 mb-4">
                IDE integration would be placed here
              </p>
              <p className="text-sm text-gray-500">
                This is where you would integrate a third-party code editor like
                Monaco Editor, CodeMirror, or Ace Editor
              </p>
            </div>
          </div>
